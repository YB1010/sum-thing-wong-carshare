...
<div id="confirm-page">
    ...
    <div id="paypal-button-container">
        ...
        <form action='index.php?r=car/cancel-car' method="post" id="cancelForm">
            <button class="btn btn-primary" id="cancel" name="cancel" value="<?php echo $_SESSION["carID"]?>">cancel</button>
        </form>
